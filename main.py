...
# 小説のURL
CodeList = [
    {'code': 'n0022gd', 'title': '水属性の魔法使い', 'Page': ''},
    {'code': 'n5542gs', 'title': 'ゲーム世界転生〈ダン活〉～ゲーマーは【ダンジョン就活のススメ】を 〈はじめから〉プレイする～', 'Page': ''},
    {'code': 'n6829bd', 'title': '賢者の弟子を名乗る賢者', 'Page': ''},
    {'code': 'n7463ho', 'title': '【Web版】剣と魔法と学歴社会 〜前世ガリ勉だった俺は今世では風任せに生きる〜', 'Page': ''},
    {'code': 'n6774eh', 'title': '元・世界１位のサブキャラ育成日記 ～廃プレイヤー、異世界を攻略中！～', 'Page': ''},
    {'code': 'n0611em', 'title': '陰の実力者になりたくて！【web版】', 'Page': ''},
    {'code': 'n1393fy', 'title': 'たとえば俺が、チャンピオンから王女のヒモにジョブチェンジしたとして。', 'Page': ''},
    {'code': 'n3040bl', 'title': 'タナカの異世界成り上がり', 'Page': ''},
    {'code': 'n1854cj', 'title': 'グリモワール×リバース～転生鬼神浪漫譚～', 'Page': ''},
    {'code': 'n9902bn', 'title': 'デスマーチからはじまる異世界狂想曲（ web版 ）', 'Page': ''},
    {'code': 'n6970df', 'title': 'ライブダンジョン！', 'Page': ''},
